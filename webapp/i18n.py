...
TEXT = {
    "es": {
        ...
        "budget_note": "Presupuesto efectivo = mín(fichajes, salario × 10). Se asume que el salario anual de un jugador es ≈10% de su valor de mercado.",
        "run_simulation": "Simular ventana de fichajes",

        # Progress
        "step_loading": "Cargando datos de la temporada...",
        "step_team": "Identificando plantilla del club...",
        "step_team_values": "Calculando valores de equipos...",
        "step_selling": "Vendiendo jugadores...",
        "step_predicting": "Prediciendo valores futuros con ML...",
        "step_knapsack": "Optimizando fichajes (Knapsack)...",
        "step_summary": "Generando análisis con IA...",
    ...
    "en": {
        ...
        "budget_note": "Effective budget = min(transfer, salary × 10). We assume a player's annual salary ≈ 10% of their market value.",
        "run_simulation": "Simulate transfer window",

        # Progress
        "step_loading": "Loading season data...",
        "step_team": "Identifying club squad...",
        "step_team_values": "Calculating team values...",
        "step_selling": "Selling players...",
        "step_predicting": "Predicting future values with ML...",
        "step_knapsack": "Optimizing signings (Knapsack)...",
        "step_summary": "Generating AI analysis...",
